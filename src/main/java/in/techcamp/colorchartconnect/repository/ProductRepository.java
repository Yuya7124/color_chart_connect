...
public interface ProductRepository {
  ...
  void insert(@Param("product_name") String product_name, @Param("color_chart")String color_chart, @Param("image_data")byte[] image_data, @Param("image_filename")String image_filename, @Param("comment")String comment);
